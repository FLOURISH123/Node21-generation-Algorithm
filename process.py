...
class Nodulegeneration(SegmentationAlgorithm):
    def __init__(self):
        ...
        with open("C:\Users\perkl\Desktop\NODE21\node21_generation_baseline-main\test\nodules.json" if execute_in_docker else "test/nodules.json") as f:
